...
const string strMessageMeison = "Meison Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Meison", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // MainNet:
        // block.GetHash() == 000004fff5c61c09152ad2e51767ae34344058a7a9c4d9b6ae0ba6abef047510
        // block.hashMerkleRoot == aa19c50153c3da72b7683a6ffb93bc53051523aeab2e6ec7508e0227eea39937
        // block.nTime = 1546970960 
        // block.nNonce = 52466
        

        const char* pszTimestamp = "Meison the good version, Jan 8 2019";
        CTransaction txNew;
        txNew.nTime = 1546970960;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0xaa19c50153c3da72b7683a6ffb93bc53051523aeab2e6ec7508e0227eea39937"));
